...
<body class="dark-sidenav">
  <?php if (get('route') != 'home' && get('route') != 'loading' && get('route') != 'api/runDataGroupHistory' && get('route') != 'loading/someone' && get('route') != 'loading/rangeall' && get('route') != 'loading/range_barcode' && get('route') != 'loading/range' && get('route') != '') { ?>
  <!-- Left Sidenav -->
      ...
      <ul class="metismenu left-sidenav-menu">
          ...
          <ul class="nav-second-level" aria-expanded="false">
            <li>
              <a href="<?php echo route('purchase'); ?>"
                class="<?php echo $_GET['route'] == 'purchase' ? 'active' : ''; ?>">
            ...
            <li>
              <a href="<?php echo route('report'); ?>"
                class="<?php echo $_GET['route'] == 'report' ? 'active' : ''; ?>">
        ...
        <li id="config">
          ...
          <ul class="nav-second-level" aria-expanded="false">
            ...
            <li>
              <a href="<?php echo route('setting&tab=config_barcode'); ?>"
        ...
        <li>
          <a href="<?php echo route('user/resetPassword'); ?>"
            class="<?php echo $_GET['route'] == 'user/resetPassword' ? 'active' : ''; ?>">
